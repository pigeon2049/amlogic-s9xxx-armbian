...
# W102D 2+16 trial, based on the clean W103D v7 Bluetooth/wireless-fixed assembly.
set -euo pipefail
if [ "$#" -ne 4 ]; then
...
PY
# Require v7 reports, then recheck the actual immutable files, not just JSON.
...
for report in bluedevil bluetooth-startup wireless-modules; do
...
name=W102D_Armbian_26.8.1_6.18.49_KDE_16GB_TEST_v3.burn.img
